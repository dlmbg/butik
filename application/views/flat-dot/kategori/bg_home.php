...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header" data-original-title="">
			...
			<i class="halflings-icon plus-sign"></i><a href="<?php echo base_url(); ?>dashboard/kategori/tambah">Tambah Data</a><span class="break"></span>
			Data Kategori</h2>
		</div>
		<div class="box-content">
			<?php echo form_open("dashboard/kategori/set"); ?>
